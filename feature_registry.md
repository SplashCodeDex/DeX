...
|---|---|---|---|---|
| NET-01 | UDP Multicast Discovery | Both | 🏗️ In Progress | Integration (CMP ↔ Legacy) |
| NET-02 | TCP / HTTP Wire Protocol | Both | 🏗️ In Progress | Unit / Wire comparison |
| NET-03 | WebSocket Control Channel | Both | 🏗️ In Progress | Integration (CMP ↔ Legacy) |
| NET-04 | mDNS / NSD Service Advertising | Both | ⏳ Not Started | LAN packet capture |
| NET-05 | Auto-Pairing (Identity Hash) | Both | ⏳ Not Started | Integration Test |
| NET-06 | Manual PIN Pairing | Both | ⏳ Not Started | Integration Test |
| NET-07 | Stale Node Cleanup / Keep-Alive | Both | ⏳ Not Started | Unit / Manual Timeout |
